#!/usr/bin/env bash
# =============================================================================
# fetch.sh — 저장소를 받아 데이터를 풀어 놓는다. 갱신의 첫 단계이다
#
...
#
# 토큰은 여기서 쓰지 않는다. 저장소가 공개라 받아 오는 데는 키가 필요 없다.
# 토큰은 올릴 때만 쓴다.
#
# 끝나면 이렇게 놓여 있다.
#   <자리>/tools/               도구
#   <자리>/public/              HTML 다섯 페이지와 스타일과 화면 만드는 코드
...
다섯 페이지는 브라우저가 그린다. 화면을 고칠 일이면 public/app.js 를 본다.
